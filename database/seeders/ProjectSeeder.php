...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $muroj = Project::create([
            ...
            'type' => 'villa',
            'status' => 'in_progress',
            'excerpt' => 'A premium beachfront residential community in Ras Al Khaimah offering luxury villas and apartments with stunning sea views.',
        ...
        ProjectUnitType::create([
            ...
            'description' => 'Compact and efficient studio with modern finishes',
            'size_min' => 45,
            'size_max' => 60,
            'display_order' => 1,
        ]);
        ...
        ProjectUnitType::create([
            ...
            'description' => 'Luxurious three-bedroom unit with premium amenities',
            'size_min' => 160,
            'size_max' => 200,
            'display_order' => 4,
        ]);
        ...
        ProjectAmenity::create([
            ...
            'description' => 'Beautifully maintained gardens throughout the community',
            'icon' => 'fa-leaf',
            'display_order' => 4,
        ]);
        ProjectAmenity::create([
        ...
        $richHills = Project::create([
            ...
            'type' => 'apartment',
            'status' => 'completed',
            'excerpt' => 'An upscale residential compound in 6 October City featuring modern villas and townhouses with premium amenities.',
        ...
        $maldives = Project::create([
            ...
            'type' => 'villa',
            'status' => 'in_progress',
            'excerpt' => 'A coastal resort-style residential development in Hurghada inspired by Maldivian architecture and lifestyle.',
        ...
        $rasAlKhaimah = Project::create([
            ...
            'type' => 'mixed_use',
            'status' => 'upcoming',
            'excerpt' => 'A mixed-use development in Ras Al Khaimah combining residential, commercial, and hospitality spaces.',
        ...
        $rasAlKhaimah->categories()->attach([$mixedUse->id, $commercial->id, $investment->id]);
        ...
        $sheikhZayed = Project::create([
            ...
            'type' => 'apartment',
            'status' => 'in_progress',
            'excerpt' => 'A smart residential community in Sheikh Zayed featuring integrated technology and sustainable design.',
        ...
        $coastalParadise = Project::create([
            ...
            'type' => 'villa',
            'status' => 'upcoming',
            'excerpt' => 'A luxury beachfront development on Egypt\'s North Coast with world-class amenities and services.',
        ...
        $coastalParadise->categories()->attach([$residential->id, $investment->id]);
