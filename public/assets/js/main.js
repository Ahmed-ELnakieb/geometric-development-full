/*
	Template Name: Geometric Development - Real Estate HTML Template
...
/* 
	Preloader code moved to preloader.js to prevent conflicts
*/
...
bsContact.from(".bs-contact-1-bg-color ", { backgroundColor: "#C3905F75" });
