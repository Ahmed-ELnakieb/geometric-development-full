...
@section('title', $post->meta_title ?? $post->title . ' - Geometric Development')
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bs-blog-item mb-30">
                    ...
                    <div class="bs-blog-content">
                        ...
                        <h4 class="title bs-h-4">
                            <a href="{{ route('blog.show', $relatedPost->slug) }}">{{ $relatedPost->title }}</a>
                        </h4>
                        <p class="bs-p-4">{{ Str::limit($relatedPost->excerpt, 100) }}</p>
                        <a href="{{ route('blog.show', $relatedPost->slug) }}" class="bs-btn-1">
                            <span class="text">Read More</span>
                            <span class="right-long"></span>
                        </a>
                    </div>
                </div>
            </div>
