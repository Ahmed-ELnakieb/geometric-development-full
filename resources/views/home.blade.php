    ...
    <div class="container bs-container-1">
        <div class="bs-gallery-2-wrap">
            ...
            <div class="left">
                ...
                <!-- img -->
                <a href="#" aria-label="name" class="bs-gallery-2-img popup-img wa-img-cover wa-fix">
                    <img src="{{ asset('assets/img/gallery/g2-img-1.png') }}" alt="">
                </a>


                <!-- img -->
                <a href="#" aria-label="name" class="bs-gallery-2-img xs-size popup-img wa-img-cover wa-fix">
            ...
            <div class="meddle">
                ...
                <div class="meddle-row-2">
                    ...
                    <!-- img -->
                    <a href="#" aria-label="name" class="bs-gallery-2-img sm-size popup-img wa-img-cover wa-fix">
                        <img src="{{ asset('assets/img/gallery/g2-img-5.png') }}" alt="">
                    </a>

                    <!-- img -->
                    <a href="#" aria-label="name" class="bs-gallery-2-img sm-size popup-img wa-img-cover wa-fix">
                        <img src="{{ asset('assets/img/gallery/g2-img-6.png') }}" alt="">
                    </a>
            ...
            <div class="right">
                ...
                <!-- img -->
                <a href="#" aria-label="name" class="bs-gallery-2-img sm-size popup-img wa-img-cover wa-fix">
                    <img src="{{ asset('assets/img/gallery/g2-img-7.png') }}" alt="">
                </a>
