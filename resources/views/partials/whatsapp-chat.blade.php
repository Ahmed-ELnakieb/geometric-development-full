...
.wa-chat-widget {
    position: fixed;
    right: 1.5%;
    bottom: -12.5%; /* Same initial position as back-to-top */
    z-index: 4; /* Same z-index as back-to-top */
    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
    transition: 0.3s; /* Same transition as back-to-top */
}
...
/* Show widget when active (same as back-to-top) */
.wa-chat-widget.active {
    bottom: 10%; /* Position above back-to-top button when active */
}

/* Chat Button - Same design as back-to-top */
.wa-chat-button {
    position: relative;
    width: 40px;
    height: 40px;
...
/* After pseudo-element for shadow effect (same as back-to-top) */
.wa-chat-button::after {
    content: "";
    width: 100%;
    height: 100%;
...
.wa-chat-button:hover .wa-chat-button-icon {
    transform: rotate(-45deg) translateY(5px); /* Same hover effect as back-to-top */
}
...
.wa-chat-notification-badge {
    ...
    transform: rotate(-45deg); /* Counter-rotate the badge */
}

/* Chat Interface */
.wa-chat-interface {
    position: absolute;
    bottom: 50px; /* Adjusted for smaller button */
    right: 0;
    width: 350px;
    height: 500px;
    background: white;
